...
<c:set var="resourceContextPath" value="${pageContext.request.contextPath}"/>
...
<script type="text/javascript">
	function modify() {
		...
		form.method = 'get';
		form.action = 'http://wwww.daum.net';
		form.submit();
...
<div id="contentwrap">
	<div id="content">
		<div id="left" class="over_container">
			<h2 style="font-size: 14px; text-align: center;">프로필사진</h2>
			<hr>
			<img src="${resourceContextPath}/resource/img/1.png" id="profile" />
		</div>
		<div id="center" class="over_container">
			<form id="memberForm" name="memberForm">
				<h1 style="font-size: 16px; text-align: center;">회원정보보기</h1>
			...
			<table>
				<tr>
					<td colspan="2" style="text-align: center;"><input
						class="bitBtn" type="button" id="JOINBTN" value="수정"
						onclick="modify();" /> <input class="bitBtn" type="button"
