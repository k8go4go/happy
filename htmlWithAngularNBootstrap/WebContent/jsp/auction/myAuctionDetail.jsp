	...
	<tbody>
		<tr>
			...
			<td class="text-left col-sm-10" rowspan="3">
				<img id="mainPreview" width='150px;' height='200px;' src='<c:url value="/product/image/${fileListVO[0].FILE_NM}" />' >
				<img id="secPreview" width='150px;' height='200px;' src='<c:url value="/product/image/${fileListVO[1].FILE_NM}" />' >
			</td>
		</tr>
		<tr></tr><tr></tr>
		<tr>
			...
			<input type="text" value="${aucVO.PROD_CATE_NM}"/>
			</td>
		</tr>
		<tr>
			<td class="text-right col-sm-2"><h6>경매유형</h6></td>
			<td class="text-center col-sm-6">
			<input type="text" value="${aucVO.AUC_TYPE_NM}"/>
			</td>
		</tr>
	</tbody>
	</table>
		...
		<tbody>							
			<tr>
				...
				<td class="text-center col-sm-8"><input type="text"
					...
					value="${aucVO.AUC_PROD_NM}"
					required />
			</tr>
			<tr>
				<td class="text-right col-sm-2"><h6>상품설명</h6></td>
				<td class="text-center col-sm-6"><textarea 
					class="input-sm col-sm-6" id="SHORT_CONT" name="SHORT_CONT"  required>
					${aucVO.SHORT_CONT}
					</textarea>
				</td>
			</tr>
			<tr>
				...
				<td class="text-center col-sm-6">
	                <input class="input-sm col-sm-6" size="16" type="text" id="START_DTIME" name="START_DTIME" value="${aucVO.START_DTIME}" readonly>
				</td>	
			</tr>
			<tr>
				<td class="text-right"><h6>종료시간</h6></td>
				<td class="text-center">
                    <input class="input-sm col-sm-6" size="16" type="text" id="END_DTIME" name="END_DTIME" value="${aucVO.END_DTIME}" readonly>
				</td>
			</tr>
			<tr>
				<td class="text-right col-sm-2"><h6>시작가격</h6></td>
				<td class="text-center col-sm-6"><input type="text"
					class="input-sm col-sm-6" id="START_PRICE" name="START_PRICE" value="${aucVO.START_PRICE}" required>
				</td>
			</tr>
			<tr>
				<td class="text-right col-sm-2"><h6>수량</h6></td>
				<td class="text-center col-sm-6"><input type="text"
					class="input-sm col-sm-6" id="QTY" name="QTY" value="${aucVO.QTY}" required />
				</td>
			</tr>
		</tbody>
	</table>
